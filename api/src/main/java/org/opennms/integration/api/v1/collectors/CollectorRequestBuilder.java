...
/**
 * This class is used by {@link ServiceCollectorClient} to build Collector Request and execute the request.
 */
public interface CollectorRequestBuilder {

    CollectorRequestBuilder withRequest(CollectionRequest agent);
