...
package org.opennms.integration.api.v1.distributed;
...
public interface KeyValueStore<T> {
     ...
     */
    Optional<T> getIfStale(String key, String context, long timestamp);
     ...
     */
    CompletableFuture<Optional<T>> getIfStaleAsync(String key, String context, long timestamp);
