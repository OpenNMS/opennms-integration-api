...
public class RequisitionBean implements Requisition {
    ...
    public static RequisitionBean.Builder builder() {
        return new RequisitionBean.Builder();
    }

    public static class Builder {
        private String foreignSource;
        private Date generatedAt;
        private List<RequisitionNode> nodes = new LinkedList<>();
