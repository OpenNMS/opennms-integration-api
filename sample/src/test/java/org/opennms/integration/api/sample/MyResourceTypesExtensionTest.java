...
public class MyResourceTypesExtensionTest {
    ...
    public void verifyResourceTypesFromXml() {
        ...
        StrategyDefinition strategyDefinition = resourceType.getStorageStrategy();
        assertThat(strategyDefinition.getParameters(), hasSize(4));
        assertThat(strategyDefinition.getClazz(), is("org.opennms.netmgt.dao.support.SiblingColumnStorageStrategy"));
        Parameter parameter = strategyDefinition.getParameters().get(2);
        assertThat(parameter.getValue(), is("s/:.*//"));
