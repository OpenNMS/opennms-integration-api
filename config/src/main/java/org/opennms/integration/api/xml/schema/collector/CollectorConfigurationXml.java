...
/**
 * Top-level element for the collector-configuration.xml
 *  configuration file.
 */
...
public final class CollectorConfigurationXml implements Serializable {
    ...
    public void setCollectors(List<CollectorXml> collectors) {
        this.collectors = Objects.requireNonNullElseGet(collectors, ArrayList::new);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CollectorConfigurationXml that = (CollectorConfigurationXml) o;
        return Objects.equals(this.packages, that.packages)
                && Objects.equals(this.collectors, that.collectors);
    }
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
                          ...
                          .add("collectors", this.collectors)
                          .toString();
    }
}
